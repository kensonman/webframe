    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth', models.IntegerField(choices=[(0, 'webframe.models.MenuItem.auth.both'), (1, 'webframe.models.MenuItem.auth.authenticated'), (2, 'webframe.models.MenuItem.auth.notAuthenticated')], default=0, help_text='webframe.models.MenuItem.auth.helptext', verbose_name='webframe.models.MenuItem.auth')),
                ('name', models.CharField(default='MainMenu', help_text='webframe.models.MenuItem.name.helptext', max_length=256, verbose_name='webframe.models.MenuItem.name')),
                ...
                ('tmpl', models.TextField(default='<li class="nav-item {class}"><a class="nav-link" target="{target}" href="{href}" title="{title}"><i class="fas {icon}"></i> {label}</a><ul class="nav">{childs}</ul></li>', help_text='webframe.models.MenuItem.tmpl.helptext', max_length=2048, verbose_name='webframe.models.MenuItem.tmpl')),
